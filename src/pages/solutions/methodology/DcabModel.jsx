...
const cdStyle = {
  ...
  accentColor: '#16a34a', // The green from the "Upload" button
      ...
      <section className="py-24 px-6 md:px-12 lg:px-24 bg-[#F1F1F1]">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-20 items-center">
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={slideInLeft} className="w-full flex justify-center items-center group">
            <img src={counterfactualImage} alt="Control Matching Analysis" className="w-full h-auto object-contain transition-transform duration-700 group-hover:scale-105" />
          </motion.div>
