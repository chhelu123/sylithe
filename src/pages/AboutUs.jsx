...
const AboutUs = () => {
    return (
        <div className="bg-[#F1F1F1] text-gray-900 font-sans w-full">
            <ScrollExpandMedia
                mediaType="video"
                    ...
                    <BackgroundGlow glowColor="#16a34a" glowOpacity={0.08} glowPosition="center 10%">
                        <section className="py-32 px-6 md:px-12 lg:px-24 max-w-7xl mx-auto w-full relative z-10">
                            ...
                            <motion.div
                                ...
                                variants={fadeUp}
                            >
                                <h2 className="text-[#16a34a] text-sm font-bold uppercase tracking-widest mb-6">
                                    About Sylithe
                                </h2>
                                <h3 className="text-4xl md:text-6xl font-[Telegraf_Bold,var(--font-sans)] font-bold text-gray-900 leading-tight">
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-start">
                                ...
                                >
                                    ...
                                    <p className="text-sm text-gray-600 italic leading-relaxed">
                                        By combining advanced satellite intelligence, geospatial analytics, and machine learning, <span className="text-gray-900 not-italic">Sylithe continuously monitors ecosystems</span> to transform static reporting into a living verification engine.
                                    </p>
                                ...
                                >
                                    ...
                                    <div className="mb-12">
                                        <p className="text-2xl text-gray-900 font-[Telegraf_Bold,var(--font-sans)] leading-relaxed mb-6">
        ...
        */}
                        <section className="py-24 px-6 md:px-12 lg:px-24 w-full w-full">
                            ...
                            >
                                ...
                                <h3 className="text-3xl md:text-5xl font-[Telegraf_Bold,var(--font-sans)] font-bold text-gray-900 leading-tight">
                                    ...
                                    >
                                        ...
                                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-center py-10">
                                            ...
                                            <div className="lg:col-span-2 flex-shrink-0">
                                                <span className="font-[Telegraf_Bold,var(--font-sans)] text-7xl md:text-8xl font-black leading-none text-gray-200 select-none">
                                                    {item.step}
                                                </span>
                                            </div>
                                            ...
                                            <div className="lg:col-span-6">
                                                <h4 className="text-gray-900 font-[Telegraf_Bold,var(--font-sans)] text-3xl md:text-4xl font-bold mb-2">
                                                    {item.label}
                                                </h4>
                                                <p className="text-[#16a34a] text-xs font-bold uppercase tracking-widest mb-4">
                                                    {item.sublabel}
                                                </p>
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
                                ...
                                >
                                    ...
                                    <div className="mb-12">
                                        ...
                                        <h3 className="text-4xl md:text-5xl font-[Telegraf_Bold,var(--font-sans)] font-bold text-gray-900 leading-tight mb-8">
                                            A foundation built on <br className="hidden md:block" />ecological truth.
                                        </h3>
                                        <p className="text-gray-600 mb-6">
                                            The name <strong className="text-gray-900 font-medium">Sylithe</strong> is a direct reflection of our core philosophy.
                                        </p>
                                        <p className="text-gray-600">
                                    ...
                                    <div className="mt-2">
                                        ...
                                        <p className="mt-3 text-xl text-gray-900 font-[Telegraf_Bold,var(--font-sans)] font-medium leading-snug">
