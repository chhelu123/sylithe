                ...
                <div className="flex gap-8 py-20 lg:py-40 items-center justify-center flex-col">
                    ...
                    <div className="flex gap-4 flex-col">
                        <h1 className="text-4xl md:text-5xl lg:text-[4.5rem] font-bold text-[#0F172A] leading-[1.1] mb-6 tracking-tight text-center">
                            ...
                            <span className="relative flex w-full justify-center overflow-hidden text-center md:pb-4 md:pt-1 text-[#84cc16]">
                                &nbsp;
                    ...
                    <div className="flex flex-row gap-3">
                        ...
                        <Button size="lg" className="gap-4 bg-[#84cc16] text-[#064e3b] hover:bg-[#0F172A] hover:text-white transition-all shadow-lg active:scale-95">
