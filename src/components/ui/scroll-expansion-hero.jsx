            ...
            <div className='flex flex-col items-center justify-center w-full h-[100dvh] relative'>
              <div
                ...
                <div className='flex flex-col items-center text-center relative z-10 mt-4 transition-none'>
                  {date &&
                    <p
                      className='text-xl text-[#A3E635] font-bold uppercase tracking-widest'
                  ...
                  {scrollToExpand &&
                    <p
                      className='text-white/70 font-medium text-center mt-2 animate-bounce'
                      style={{ transform: `translateX(${textTranslateX}vw)` }}>
              ...
              <div
                ...
                <motion.h2
                  className='text-5xl md:text-7xl lg:text-8xl font-[Telegraf_Bold,var(--font-sans)] font-black text-white transition-none leading-none'
                  style={{ transform: `translateX(-${textTranslateX}vw)` }}>

                  {firstWord}
                </motion.h2>
                <motion.h2
                  className='text-5xl md:text-7xl lg:text-8xl font-[Telegraf_Bold,var(--font-sans)] font-black text-center text-white transition-none leading-none'
                  style={{ transform: `translateX(${textTranslateX}vw)` }}>
