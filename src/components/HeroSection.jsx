      ...
      <section className="relative w-full h-screen flex items-center overflow-hidden bg-white">
        <div className="relative z-10 w-full h-full grid lg:grid-cols-2 items-center px-6 md:px-12 lg:px-16">
          ...
          <div className="flex justify-start">
            ...
            >
              <motion.h1 variants={textVariant} className="text-[64px] font-[Telegraf_Bold,var(--font-sans)] font-bold text-[#08292F] leading-[1.0] tracking-normal mb-6 max-w-[450px]">
                The carbon <br className="hidden md:block" /> intelligence <br />
              ...
              <motion.p variants={textVariant} className="text-[1.35rem] leading-snug text-[#1a383a] mb-10 max-w-2xl font-[Telegraf_Bold,var(--font-sans)] font-medium tracking-tight">
      ...
      <section className="py-24 px-6 md:px-12 lg:px-24 bg-gray-50/50 border-y border-gray-100">
        <div className="max-w-7xl mx-auto">
          <motion.div
            ...
            className="mb-16"
          >
            <span className="text-slate-500 font-[Telegraf_Bold,var(--font-sans)] font-bold text-sm uppercase tracking-wide">Benefits with Sylithe</span>
            <h2 className="text-3xl md:text-4xl font-[Telegraf_Bold,var(--font-sans)] font-bold text-[#0F172A] mt-3 max-w-3xl leading-tight tracking-tight">
          ...
          >
            {[
              ...
              <motion.div key={index} variants={textVariant} className="flex flex-col gap-4">
                ...
                <p className="text-slate-600 text-sm leading-relaxed font-[Telegraf_Bold,var(--font-sans)] font-medium">{item.desc}</p>
              </motion.div>
            ))}
          </motion.div>
        </div>
          ...
          >
            <div className="flex flex-col items-start gap-0">
              <motion.h3
                ...
                className="text-3xl md:text-4xl lg:text-5xl font-[Telegraf_Bold,var(--font-sans)] font-bold text-[#0F172A] leading-[1.1] mb-5 tracking-tight"
              >
                High-quality carbon, backed by evidence
              </motion.h3>

              <motion.p variants={textVariant} className="text-lg text-slate-600 leading-relaxed max-w-lg mb-8 font-[Telegraf_Bold,var(--font-sans)] font-normal">
